...
//corner buttons
	...
	"throw"              = list("type" = /obj/screen/HUDthrow,          "loc" = "EAST+1,BOTTOM:13", "minloc" = "RIGHT,2:13",   "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
	"pull"               = list("type" = /obj/screen/pull,              "loc" = "EAST-1,BOTTOM:13", "minloc" = "RIGHT-2,2:13", "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
	"drop"               = list("type" = /obj/screen/drop,              "loc" = "EAST+1,BOTTOM",    "minloc" = "RIGHT,2",      "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
	"resist"             = list("type" = /obj/screen/resist,            "loc" = "EAST-1,BOTTOM",    "minloc" = "RIGHT-2,2",    "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
	"rest"               = list("type" = /obj/screen/rest,              "loc" = "EAST,BOTTOM",      "minloc" = "RIGHT-1,2",    "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
	"block"              = list("type" = /obj/screen/block,             "loc" = "EAST+1,BOTTOM+1:26", "minloc" = "RIGHT,3:-6", "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
	"move intent"        = list("type" = /obj/screen/mov_intent,        "loc" = "EAST,BOTTOM-1",        "minloc" = "RIGHT-1,1",    "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back1"),
	...
	"craft menu"         = list("type" = /obj/screen/craft_menu,        "loc" = "EAST-2:16,BOTTOM-1",   "minloc" = "12:16,1",      "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back13"),
	"wield"              = list("type" = /obj/screen/wield,             "loc" = "EAST-2:16,BOTTOM", "minloc" = "12:16,2",      "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back13"),
	"intent"             = list("type" = /obj/screen/intent,            "loc" = "EAST-1,BOTTOM-1",      "minloc" = "13,1",         "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back1"),
	"damage zone"        = list("type" = /obj/screen/zone_sel,          "loc" = "EAST+1,BOTTOM-1",      "minloc" = "RIGHT,1",      "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back1"),
//hand buttons
